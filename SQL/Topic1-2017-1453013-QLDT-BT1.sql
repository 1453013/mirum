...
Insert into ThamGiaDT values ('ngtuan','11','1','1000000','hoanthanh'),
							('ngphuc','21','2','1000000','hoanthanh'),
							('ngson','31','3','1000000','hoanthanh')
...
ASBegin transaction	Begin try 	if @MaDT = null OR @NgayBD = null or @NgayKT = null	Begin 		print 'Thong tin nhap khong hop le'		rollback transaction		return	End	if NOT EXISTS (Select *
	...
	End catch
		...
		Insert into CongViec values (@MaDT,@TenCV,@SoTT,@NgayBD,@NgayKT)	
...
EXECUTE ThemCongViec @MaDT= '21',
@TenCV = 'Thu thap 2',
@SoTT = '2',
@NgayBD ='11/10/2017',
@NgayKT = '12/11/2017'GO

EXECUTE CapNhatCongViec @MaDT= '11',
@SoTT = '1',
@TenCV = 'Thu thap 2',
@NgayBD ='11/10/2017',
@NgayKT = '12/11/2017'GOEXECUTE XoaCongViec@MaDT='11',@SoTT='1'GOEXECUTE ThemDeTai@MaDT='41',
